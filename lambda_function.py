...
class InstanceTypeDescription(Enum):
    G4DN = "NVIDIA T4 GPU"
    G4AD = "AMD Radeon Pro V520"
    G5 = "NVIDIA A100 GPU"

class InstanceTypeLongDescription(Enum):
    G4DN = "NVIDIA T4 GPU with 16GB of memory"
    G4AD = "AMD Radeon Pro V520 with 16GB of memory"
    G5 = "NVIDIA A100 GPU with 40GB of memory"


class InstanceTypeXtraLongDescription(Enum):
    G4DN = "NVIDIA T4 GPU with 16GB of memory, 125 TFLOPS"
    G4AD = "AMD Radeon Pro V520 with 16GB of memory, 6.4 TFLOPS"
    G5 = "NVIDIA A100 GPU with 40GB of memory, 312 TFLOPS"
